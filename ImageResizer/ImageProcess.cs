...
namespace ImageResizer
{
    public class ImageProcess
    {
        ...
        public void ResizeImagesAsync(string sourcePath, string destPath, double scale)
        {
            ...
            foreach (var filePath in allFiles)
            {
                Task taskResizeImages = Task.Run(async () => await DoResizeImages(filePath, destPath, scale));
        ...
        /// <returns></returns>
        public static async Task DoResizeImages(string filePath, string destPath, double scale)
        {
            Image imgPhoto = Image.FromFile(filePath);
            string imgName = Path.GetFileNameWithoutExtension(filePath);
            ...
            Bitmap processedImage = new ImageProcess().processBitmap((Bitmap)imgPhoto,
                sourceWidth, sourceHeight,
                destionatonWidth, destionatonHeight);
